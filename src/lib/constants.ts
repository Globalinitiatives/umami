...
export const AUTH_TOKEN = 'gmanalytics.auth';
export const LOCALE_CONFIG = 'gmanalytics.locale';
export const TIMEZONE_CONFIG = 'gmanalytics.timezone';
export const DATE_RANGE_CONFIG = 'gmanalytics.date-range';
export const THEME_CONFIG = 'gmanalytics.theme';
export const CURRENCY_CONFIG = 'gmanalytics.currency';
export const DASHBOARD_CONFIG = 'gmanalytics.dashboard';
export const LAST_TEAM_CONFIG = 'gmanalytics.last-team';
export const VERSION_CHECK = 'gmanalytics.version-check';
...
export const HOMEPAGE_URL = 'https://gmanalytics.opiscope.com';
export const DOCS_URL = 'https://gmanalytics.opiscope.com/docs';
export const REPO_URL = 'https://github.com/umami-software/umami';
export const UPDATES_URL = 'https://gmanalytics.opiscope.com/api/updates';
export const TELEMETRY_PIXEL = 'https://i.gmanalytics.opiscope.com/a.png';
